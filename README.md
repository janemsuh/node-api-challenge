...
- [ ] Describe Middleware?
Middleware functions can operate on request and response objects and can trigger another action.

- [ ] Describe a Resource?
Any set of data on the server equals a resource.

- [ ] What can the API return to help clients know if a request was successful?
The API can return a status code indicating if a request was successful or not.
